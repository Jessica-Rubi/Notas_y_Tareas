...
public class ListaAdapterT extends BaseAdapter implements Filterable {
    // Declare Variables
    Context context;
    String[] titulos;
    int[] imagenes;
    ...
    public ListaAdapterT(Context context, String[] titulos, int[] imagenes) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View itemView = inflater.inflate(R.layout.lista_tareas, viewGroup, false);
